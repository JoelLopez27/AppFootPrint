...
class FootprintTransitTravelFragment : Fragment() {

    private lateinit var mBinding: FragmentFootprintTransitTravelBinding
    ...
    override fun onCreateView(
        ...
        mBinding = FragmentFootprintTransitTravelBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        ArrayAdapter.createFromResource(
            requireContext(), R.array.type_transit, android.R.layout.simple_spinner_dropdown_item
        ).also { adapter ->
        ...
        mBinding.btnCalcular.setOnClickListener {
            if (!mBinding.etKm.text.toString().isEmpty()&&!spinner.selectedItem.equals("-Seleccionar Tipo de Motocicleta-")) {
                viewModel.getResultTransit(
                    mBinding.etKm.text.toString(),
                    spinner.selectedItem.toString()
                )
                it.findNavController()
                    .navigate(R.id.action_footprintTransitTravelFragment_to_fragmentResult)
